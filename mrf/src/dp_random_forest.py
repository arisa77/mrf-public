...
class DPVerticalExtraTrees(VerticalExtraTrees):
    def __init__(self, schema, depth, n_estimators, n_ensembles=1, bootstrap=False, disjoint=False,random_state=None,n_jobs=None,alg='ID3'):
        super().__init__(schema, depth, n_estimators, n_ensembles=n_ensembles, bootstrap=bootstrap, disjoint=disjoint,random_state=random_state,n_jobs=n_jobs,alg=alg)
